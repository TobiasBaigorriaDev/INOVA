                ...
                <tbody>
                  {productos.map((producto) => (
                    <tr key={producto.id}>
                      ...
                      <td>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                          <input type="number" value={producto.stock !== undefined ? producto.stock : ''} onChange={(e) => handleTableFieldChange(producto.id, 'stock', e.target.value)} style={{ width: '70px', padding: '8px', border: '1px solid #dddddd', borderRadius: '8px', fontSize: '14px', textAlign: 'center' }} min="0" />
